        ...
        <form class="layui-form login-bottom">
            <div class="center">
                ...
                <div id="validatePanel" class="item" style="width: 137px;">
                    ...
                    <img id="refreshCaptcha" class="validateImg"  src="${pageContext.request.contextPath}/captcha/create" >
                </div>
...
<script>
    layui.use(['form','jquery'], function () {
        ...
        $("#refreshCaptcha").click(function () {
            this.src='${pageContext.request.contextPath}/captcha/create?id='+new Date();
        });
        // 进行登录操作
            ...
            $.ajax({
                ...
                success:function (res) {
                    if(res.code==200){
                        ...
                        //验证码点击刷新事件
                        $("#refreshCaptcha").attr("src","${pageContext.request.contextPath}/captcha/create?" + Math.random());
                        layer.msg(res.msg)
                    }
                }
            })
